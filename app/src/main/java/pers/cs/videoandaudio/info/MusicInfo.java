package pers.cs.videoandaudio.info;
...
public class MusicInfo implements Parcelable {
    ...
    public MusicInfo(Parcel source) {
        this.songId = source.readLong();
        this.albumId = source.readInt();
        this.albumName = source.readString();
        this.albumData = source.readString();
        ...
        this.folder = source.readString();
        this.lrc = source.readString();
        this.islocal = source.readByte() == 1;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.albumData);
