...
*/
package pers.cs.videoandaudio.manager;
...
public final class VideoPlayerManager {
    ...
    private VideoViewVitamio mVideoPlayer;
    /**
     * 用volatile关键字修饰对象
     ...
     * @return          VideoPlayerManager对象
     */
    public VideoViewVitamio getCurrentVideoPlayer() {
        return mVideoPlayer;
    }
     ...
     */
    public void setCurrentVideoPlayer(VideoViewVitamio videoPlayer) {
    ...
    public void suspendVideoPlayer() {
        if (mVideoPlayer != null) {
            if (mVideoPlayer.isPlaying() || mVideoPlayer.isBuffering()){
                mVideoPlayer.pause();
            }
        }
    }
